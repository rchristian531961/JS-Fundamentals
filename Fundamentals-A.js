...
async function fetchUdata(url){
    const fetchPromise= await fetch(url);
    //Everything Below this line is waiting on the fetch request from above due to await
...
fetchUdata('https://jsonplaceholder.typicode.com/todos/1').then(data => console.log(data))
.catch(error => console.error(error.message));
